 ...
 *
 */
class GdGradientAlpha
{

    // Constructor. Creates, fills and returns an image
    public function __construct($w,$h,$d,$rgb,$as,$ae,$step=0)
    {
        $this->width = $w;
        $this->height = $h;
        $this->direction = $d;
    ...
    public function fillalpha($im,$direction,$rgb,$as,$ae)
    {
    ...
    public function a2sevenbit($alpha)
    {
