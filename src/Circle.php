...
use OpenStreetMapStaticAPIHeatmap\Utils\GeographicConverter;
use OpenStreetMapStaticAPIHeatmap\Geometry2D;
use OpenStreetMapStaticAPIHeatmap\Image;

/**
 * OpenStreetMapStaticAPIHeatmap\Circle draw circle on the map.
 *
